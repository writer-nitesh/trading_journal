...
const Plans = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      values: {
        starter: "Manual",
        pro: "Auto (hourly)",
        enterprise: "Auto (near real-time)",
      },
    },
    {
    ...
    },
    {
      ...
      icon: Globe,
      values: {
        starter: "5 reports per month",
        pro: "Unlimited",
        enterprise: "Custom rules & playbooks",
      },
    },
    {
      name: "Email Reports",
      ...
      values: {
        starter: false,
        pro: "Weekly + Monthly deep dive",
        enterprise: "Custom cadence + SLA",
      },
    },
    {
  ...
  const billingToggleStyle = {
    ...
    padding: "8px",
    borderRadius: "9999px",
    background: isDarkMode ? "rgba(31, 41, 55)" : "#f9fafb",
  ...
  const tableContainerStyle = {
    ...
    overflow: "hidden",
    background: isDarkMode ? "rgba(31, 41, 55)" : "#ffffff",
    border: isDarkMode
  ...
  const popularCellStyle = {
    ...cellStyle,
    background: isDarkMode ? "rgba(88, 28, 135)" : "rgba(0, 153, 102, 0.05)",
  };
  ...
  const handlePayment = async (planId, type) => {
    ...
    const price =
      selectedPlan[type === "yearly" ? "annualPrice" : "monthlyPrice"];
    const amt = type === "yearly" ? price * 12 : price
    if (selectedPlan) {
        ...
        return (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() =>
                  handlePayment(plan.id, isAnnual ? "yearly" : "monthly")
                }
                style={
                  plan.id === "pro"
                    ? primaryButtonStyle
                  ...
                  {plans.map((plan) => {
                    ...
                    return (
                      <div
                        key={plan.id}
                        style={
                          plan.popular ? popularCellStyle : headerCellStyle
                        }
                      >
                        <div style={iconContainerStyle}>
                          <IconComponent
